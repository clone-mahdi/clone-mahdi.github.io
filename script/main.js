document.addEventListener("DOMContentLoaded", ()=> {
   ...
   //syntax highlighter
   for (x in code){
      w3CodeColor(code[x], code[x].getAttribute("lang"));
   }
...
function w3CodeColor(elmnt, mode) {
  ...
  var tagcolor = "#fff";
  var tagnamecolor = "hsl(330,100%,50%)";
  var attributecolor = "hsl(120,100%,50%)";
  var attributevaluecolor = "hsl(50,100%,50%)";
  var commentcolor = "gray";
  var cssselectorcolor = "hsl(330,100%,50%)";
  var csspropertycolor = "hsl(120,100%,50%)";
  var csspropertyvaluecolor = "hsl(200,100%,50%)";
  var cssdelimitercolor = "#fff";
  var cssimportantcolor = "hsl(330,100%,50%)";  
  var jscolor = "#fff";
  var jskeywordcolor = "hsl(200,100%,50%);font-style:italic;";
  var jsstringcolor = "hsl(60,100%,50%)";
  var jsnumbercolor = "hsl(330,100%,50%)";
  var jspropertycolor = "hsl(120,100%,50%)";
